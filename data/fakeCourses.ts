...
export const fakeCourses: CourseCardProps[] = [
  {
    id: "course1",
    thumbnail: "https://images.pexels.com/photos/1591061/pexels-photo-1591061.jpeg",
  ...
  },
  {
    ...
    description: "Nắm vững React hiện đại với Hooks, Context và thực hành dự án.",
    oldPrice: 799000,
    price: 0,
    students: 2156,
    maxOnline: 512,
  ...
  },
  {
    ...
    description: "Làm chủ JavaScript hiện đại với ES6+, Async/Await và Design Pattern.",
    oldPrice: 799000,
    price: 349000,
    students: 3058,
    maxOnline: 645,
  ...
  },
  {
    ...
    description: "Xây dựng giao diện đẹp, responsive và tối ưu với Tailwind CSS.",
    oldPrice: 499000,
    price: 249000,
    students: 1724,
    maxOnline: 294,
  ...
  },
  {
    ...
    description: "Triển khai ứng dụng bằng Docker và Docker Compose trong thực tế.",
    oldPrice: 649000,
    price: 299000,
    students: 1387,
    maxOnline: 198,
